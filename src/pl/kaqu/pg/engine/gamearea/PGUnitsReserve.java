...
public class PGUnitsReserve {

	private int amountOfReserve;

	public PGUnitsReserve(int amountOfReserve) {
		this.amountOfReserve = amountOfReserve;
	}
